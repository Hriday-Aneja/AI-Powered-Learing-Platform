...
const domainTabs: { id: Domain | "All"; label: string; icon: any; color: string }[] = [
  ...
  { id: "WebDev", label: "Web Dev", icon: Globe, color: "#00d4ff" },
  { id: "AIML", label: "AI/ML", icon: Brain, color: "#a855f7" },
  { id: "DBMS", label: "DBMS", icon: Database, color: "#22c55e" },
  { id: "OS", label: "OS", icon: Cpu, color: "#f59e0b" },
  { id: "OOPS", label: "OOP", icon: Layout, color: "#ec4899" },
];
    ...
    <div className="p-4 lg:p-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <p style={{ fontSize: '13px', color: '#4a5568' }}>
          Master DSA, Web Dev, AI/ML, DBMS, OS & OOP — all in one place
        </p>
      </motion.div>
